...
export function applySchema(db: Database.Database): void {
  db.exec(`
    ...
    CREATE INDEX IF NOT EXISTS idx_pick_sessions_completed
      ON pick_sessions(completed_at DESC);
    CREATE INDEX IF NOT EXISTS idx_pick_sessions_picker
      ON pick_sessions(completed_by_user_id, completed_at DESC);
    CREATE INDEX IF NOT EXISTS idx_pick_session_items_session
      ON pick_session_items(pick_session_id);
    CREATE INDEX IF NOT EXISTS idx_pick_session_items_search
      ON pick_session_items(sku_snapshot, product_name_snapshot);
    CREATE INDEX IF NOT EXISTS idx_pick_session_components_item
